...
describe('completed project PDF',()=>{
  it('includes start-to-finish summaries and appendices',()=>{
    const html=buildProjectCompletionHtml(
      ...
      {name:'DROMEX',logoUri:null,address:null,phone:null,email:null,taxVatNumber:null,ministryName:null,ministryNameAr:null,ministryLogoUri:null,consultingAgencyName:null,consultingAgencyNameAr:null,customHeaderEn:null,customHeaderAr:null},null,[],
    );
