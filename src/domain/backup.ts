...
export const BACKUP_COUNT_TABLES: readonly string[] = ['loads','projects','customers','daily_project_reports','quarry_purchases','waste_dumps','fuel_movements','opening_balances','account_payments','payment_entries','schedule_tasks','pavement_calculations','walls','wall_consumptions','project_issues','project_media','quick_text_documents','suppliers','driver_profiles','truck_profiles','machine_profiles','catalog_items','custom_directories','custom_directory_entries','supervisors'];
