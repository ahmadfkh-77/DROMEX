...
import {calculateFoundationVolume,describeFoundationQuantity,diffFoundation,validateFoundationDraft,validateFoundationLifecycle,validateFoundationStatusChange,type Foundation,type FoundationCorrectionDraft,type FoundationDraft,type FoundationStatusChange} from '../../domain/foundations';
...
type FoundationRow={id:string;project_id:string;construction_section_id:string;legacy_wall_id:string|null;reference:string;location:string|null;length_m:number;height_m:number;bottom_thickness_m:number;top_thickness_m:number;deduction_m3:number;gross_volume_m3:number;net_volume_m3:number;material_type:Foundation['materialType'];concrete_purpose:Foundation['concretePurpose'];custom_purpose_id:string|null;custom_purpose_label:string|null;quantity:number|null;quantity_unit:Foundation['quantityUnit'];manual_override:number;consumption_date:string|null;status:Foundation['status'];constructed_on:string|null;curing_started_on:string|null;cured_on:string|null;curing_note:string|null;notes:string|null;correction_history_json:string|null;created_at:string;updated_at:string|null;foundation_mode:FoundationCompositionMode;stone_core_mode:StoneCoreMode|null;stone_core_position_x:number|null;stone_core_position_y:number|null;stone_core_offsets_json:string|null};
