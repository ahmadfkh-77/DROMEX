...
export function SignaturePad({ value, onChange, onSigningChange, hint = 'Driver signs here' }: { value: string[]; onChange: (paths: string[]) => void; onSigningChange?: (signing: boolean) => void; hint?: string }) {
