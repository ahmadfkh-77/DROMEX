...
const ARABIC_LABELS: Record<string, string> = {
  ...
  Workers: 'العمال', Drivers: 'السائقون', Operators: 'المشغلون', 'Truck Plates': 'لوحات الشاحنات', Machines: 'الآليات',
  'Custom Resources': 'موارد إضافية', 'Directory ID': 'معرف الدليل', Directory: 'الدليل', 'Entry ID': 'معرف البند', Entry: 'البند', Identifier: 'المعرف', 'Report Note': 'ملاحظة التقرير',
  'Supervisor Sign-off': 'توقيع المشرف', 'Supervisor ID': 'معرف المشرف', Supervisor: 'المشرف', 'Job Title': 'المسمى الوظيفي', 'Sign-off': 'نوع التوقيع', Order: 'الترتيب',
  'Supplier Load Subtotals': 'مجاميع أحمال الموردين', Level: 'المستوى', 'Total Quantity': 'الكمية الإجمالية',
...
const ARABIC_VALUES: Record<string, string> = {
  ...
  Workers: 'العمال', Drivers: 'السائقون', Operators: 'المشغلون', Operator: 'مشغل', 'Truck Plates': 'لوحات الشاحنات', Machines: 'الآليات', used: 'مستخدمة', transported: 'منقولة',
