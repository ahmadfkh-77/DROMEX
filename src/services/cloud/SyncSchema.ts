...
export const entityTable:Record<string,string>={category:'categories',catalogItem:'catalog_items',customer:'customers',companySettings:'company_settings',taxSettings:'tax_settings',fuelPrice:'fuel_price_history',measurementUnit:'measurement_units',conversionOption:'conversion_options',project:'projects',driverProfile:'driver_profiles',person:'driver_profiles',workerProfile:'driver_profiles',truckProfile:'truck_profiles',machineProfile:'machine_profiles',load:'loads',loadSignature:'loads',dailyProjectReport:'daily_project_reports',supplier:'suppliers',quarryPurchase:'quarry_purchases',openingBalance:'opening_balances',payment:'payment_entries',wasteDump:'waste_dumps',quickText:'quick_text_documents',fuelMovement:'fuel_movements',scheduleTask:'schedule_tasks',pavementCalculation:'pavement_calculations',wall:'walls',wallConsumption:'wall_consumptions',wasteCounter:'waste_counter_presets',projectIssue:'project_issues',projectPhoto:'project_media',loadDraft:'load_drafts'};
