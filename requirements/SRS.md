...
- Database migration 37 shall add the saved-purpose table and nullable purpose and correction columns, and migration 38 shall add the nullable volume-calculation columns, neither modifying any existing record; backups shall carry all of this data unchanged (DEC-454, DEC-456).
